    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "1874110912887664",
               appSecret: "93f7a313271ca7691bb18f85a6bd7d07"
               );

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "721042303651-cvh91pkddn91u1t5f0itvqstdq6ogibm.apps.googleusercontent.com",
                ClientSecret = "VDvB18ayBW8wgbMzity4DrEs"
            });
