...
namespace RojgarmitraSolution.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (!string.IsNullOrEmpty(accountModel.EmailID) && !string.IsNullOrEmpty(accountModel.Password))
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    if (responseMessage.IsSuccessStatusCode)
                    {
                        ...
                        accountModel = JsonConvert.DeserializeObject<AccountModel>(result);
                        ...
                        {
                            TempData["Message"] = "Incorrect username and/or password";
                        }
                    }
                    else
                    {
        ...
        //             //return RedirectToAction("Login", new { ReturnUrl = returnUrl,model. = model.RememberMe });
        ...
        // //
        /////* GET: /Acc*/ount/ExternalLoginCallback
        //[AllowAnonymous]
        ...
        //     {
        //         client_id = "158526671483625",
        //         client_Secret = "d2edab7cad88276709bea444a00ab045",
        ...
        //     dynamic me=fb.Get("me?fields=link,first_name,last_name,email,gender,locale,timezone,verified,picture,age_range");
        ...
        //     // Request a redirect to the external logproviderin provider
        //     return RedirectToAction("Index", "Home");
        // }
